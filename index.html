...
<head>
    <base href="/claim-reward/">
    <meta charset="utf-8" />
    <title>Claim your Reward</title>
    <script src="/cdn-cgi/apps/head/rsjQeg9CKMkfLDB8kU7GG-F1JRE.js"></script><link href='//fonts.googleapis.com/css?family=Neuton:200,300,400,700,400italic|Open+Sans:400,700|Lato:400,700' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="app.css?v=5" media="all" />
    <link rel="icon" type="image/png" href="https://hypixel.net/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="https://hypixel.net/favicon-16x16.png" sizes="16x16" />
</head>
<body>
    <script>
        window.appData = '{"error":"This link either never existed or has already expired.","id":"636b54ad"}';
        window.i18n = {
                ...
                "browserOutdated": "Your browser is either outdated or does not support modern web technologies and won\'t be able to run this website. Please change or upgrade your browser. We do heavily recommend Chrome for the best experience.",
    ...
    <script>
      ...
      ga('create', 'UA-34641859-6', 'auto');
      ga('send', 'pageview');
    </script>
    <script type="text/javascript" src="//www.youtube.com/iframe_api" async></script>
    <script src="app.js?v=NF38qnd9"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vef91dfe02fce4ee0ad053f6de4f175db1715022073587" integrity="sha512-sDIX0kl85v1Cl5tu4WGLZCpH/dV9OHbA4YlKCuCiMmOQIk4buzoYDZSFj+TvC71mOBLh8CDC/REgE0GX0xcbjA==" data-cf-beacon='{"rayId":"88cf5eee482fabd6","version":"2024.4.1","token":"f3771f7e976f42e9a8e7ac5210bdeaa5"}' crossorigin="anonymous"></script>
</body>
</html>
